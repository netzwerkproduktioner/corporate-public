...
var interfaceConfig = {
    APP_NAME: 'Videokonferenzserver - Björn Englert GmbH',
    ...
    JITSI_WATERMARK_LINK: 'https://jitsi.bjoern-englert.net',
    ...
    OPTIMAL_BROWSERS: [ 'chrome', 'chromium', 'nwjs', 'electron', 'egde' ],
