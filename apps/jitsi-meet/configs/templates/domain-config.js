...
var config = {
    ...
    hosts: {
        ...
        anonymousdomain: 'guest.{{SUBDOMAIN.DOMAIN.TLD}}',

        // When using authentication, domain for guest users.
        // anonymousdomain: 'guest.example.com',

        // Domain for authenticated users. Defaults to <domain>.
        // authdomain: '{{SUBDOMAIN.DOMAIN.TLD}}',

        // Focus component domain. Defaults to focus.<domain>.
        // focus: 'focus.{{SUBDOMAIN.DOMAIN.TLD}}',

        // XMPP MUC domain. FIXME: use XEP-0030 to discover it.
        muc: 'conference.' + subdomain + '{{SUBDOMAIN.DOMAIN.TLD}}',
    },

    // BOSH URL. FIXME: use XEP-0156 to discover it.
    bosh: 'https://{{SUBDOMAIN.DOMAIN.TLD}}/' + subdir + 'http-bind',

    // Websocket URL (XMPP)
    // websocket: 'wss://{{SUBDOMAIN.DOMAIN.TLD}}/' + subdir + 'xmpp-websocket',
    ...
    // focusUserJid: 'focus@auth.{{SUBDOMAIN.DOMAIN.TLD}}',

    // Option to send conference requests to jicofo over http (requires nginx rule for it)
    // conferenceRequestUrl:
    //   'https://<!--# echo var="http_host" default="{{SUBDOMAIN.DOMAIN.TLD}}" -->/' + subdir + 'conference-request/v1',
    ...
    //     // by default uses:
    //     // 'https://{{SUBDOMAIN.DOMAIN.TLD}}/static/oauth.html'
    //     redirectURI:
    //          'https://{{SUBDOMAIN.DOMAIN.TLD}}/subfolder/static/oauth.html',
    // },
    ...
    p2p: {
        ...
        stunServers: [
            ...
            // { urls: 'stun:{{SUBDOMAIN.DOMAIN.TLD}}:3478' },
    ...
    */
    ...
    // moderatedRoomServiceUrl: 'https://moderated.{{SUBDOMAIN.DOMAIN.TLD}}',
